...
style windowone:
    xalign 0.5
    xfill True
    yalign gui.ntextbox_yalign
    ysize gui.ntextbox_height

    background Image("gui/textbox2.png", xalign=1.0, yalign=1.0)
...
style nameboxone:
    ...
    xpos gui.nname_xpos
    xanchor gui.nname_xalign
    xsize gui.nnamebox_width
    ypos gui.nname_ypos
    ysize gui.nnamebox_height
    
    background Frame("gui/namebox1.png", gui.nnamebox_borders, tile=gui.nnamebox_tile, xalign=gui.nname_xalign)
    padding gui.nnamebox_borders.padding
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        text FileTime(slot, format=_("{#file_time}%A, %d de %B %Y, %H:%M"), empty=_("")):
